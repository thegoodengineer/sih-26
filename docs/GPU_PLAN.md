...
| What the documents say | README, `docs/PS26119_COVERAGE.md` and the demo's section 6 all say the same thing in the same words since #213: GPU acceleration is not on `main`, PR #153 is open and has never been built or measured here, and no speed-up is claimed. That stays true until section 5 below produces a CSV. |
