...
- The **scale evidence stops at 100,000** rows and columns, and on one generated shape (#198). That is the thousands end of what the problem statement asks for; the millions end is not measured at all, and section 1f of `docs/BENCHMARKS.md` says so where the numbers are.
