...
| MIPLIB benchmark | **done, weakly** | #24 — 30 instances at 60 s on `adcee1b`: 13 reach the published optimum, 6 prove it (6 optimal, 21 feasible, 3 node limit; `bench/results/miplib-adcee1b.csv`, on AC). Reliability branching (#69) landed and did not move the proof rate; cutting planes (#23) are what it waits on. |
